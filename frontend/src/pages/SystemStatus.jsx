                    ...
                    <div className="grid grid-cols-2 gap-6 mt-8">
                       ...
                       <div className="bg-gray-50 border p-6 rounded-lg text-left shadow-sm hover:shadow-md transition">
                           ...
                           <div className={`text-2xl font-bold ${status.status === 'ONLINE' ? 'text-green-600' : 'text-red-600'} flex items-center inline-flex`}>
                               {status.status}
                               {status.status === 'ONLINE' && <div className="ml-3 h-3 w-3 rounded-full bg-green-500 animate-pulse"></div>}
                           </div>
                       </div>
                       <div className="bg-gray-50 border p-6 rounded-lg text-left col-span-2 shadow-sm flex justify-between items-center text-sm font-mono text-gray-600">
