...
import { 
    ...
    ShieldCheck, Smartphone, Eye, LayoutGrid
} from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    if (loading || !telemetry) return <div className="p-20 text-center text-blue-500 font-mono animate-pulse uppercase tracking-[0.5em]">Establishing Secure SOC Link...</div>;
    ...
    const metrics = [
        { label: 'API Throughput', val: `${telemetry.apiTraffic || 0} req/m`, Icon: Zap, color: 'text-yellow-400' },
        { label: 'CPU Cluster Load', val: `${telemetry.cpuUsage || 0}%`, Icon: Server, color: 'text-blue-400' },
        { label: 'Latency (Avg)', val: `${telemetry.latency || 0}ms`, Icon: Activity, color: 'text-emerald-400' },
        { label: 'Error Margin', val: `${telemetry.errorRate || 0}%`, Icon: ShieldAlert, color: 'text-red-400' }
    ];

    return (
        <div className="max-w-7xl mx-auto space-y-8 pb-20 scale-in-center">
            {/* SOC Header */}
