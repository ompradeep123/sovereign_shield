                            ...
                            <div key={idx} className="relative pl-8">
                                ...
                                <div className="bg-gray-50 rounded-lg p-5 border border-gray-100 hover:border-sovBlue hover:shadow-md transition-all">
                                    <div className="flex justify-between items-start mb-2">
                                        <h4 className="font-semibold text-gray-800">{event.service} System</h4>
                                    ...
                                    <p className="text-sm text-sovNavy bg-white p-2 rounded border border-gray-200 mt-1 font-mono">{event.reason}</p>
                                </div>
                            </div>
                        ))
                    )}
